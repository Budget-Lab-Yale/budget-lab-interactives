...
| Deficits and Affordability | https://interactives.budgetlab.yale.edu/tools/deficits-affordability/ | [`tools/deficits-affordability/`](tools/deficits-affordability/) |
...
```html
<script src="https://interactives.budgetlab.yale.edu/embed/v1/embed.js" data-tool="deficits-affordability/versions/2026-05-11"></script>
```
