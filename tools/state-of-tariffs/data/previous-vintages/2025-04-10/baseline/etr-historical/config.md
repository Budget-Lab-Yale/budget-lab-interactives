...
_Notes: Published in the original release as Figure 2. The source workbook's "Current Post/Pre-Substitution Rate" columns are constant across the full 1790-2024 range (18.536%/26.998%), so the "current average" reference lines render as flat throughout._
