...
_Notes: This figure has no direct counterpart in the reference (2025-10-30) vintage structure; it is included here as an additional figure since it was published in the June 1, 2025 release (Figure 2). As with the prior vintages, this vintage distinguishes pre- and post-substitution average effective tariff rates, so both are shown here as separate reference lines._
