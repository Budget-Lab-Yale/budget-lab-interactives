...
_Notes: Table only -- the bar-chart part of this figure was removed. Adds a "Difference (Dynamic − Conventional)" row, taken from the source's own "Dynamic effect" row in Table 3, and a "2026-35" 10-year total._
