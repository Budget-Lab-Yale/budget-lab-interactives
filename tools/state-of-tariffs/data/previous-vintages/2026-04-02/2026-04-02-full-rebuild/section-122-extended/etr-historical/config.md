...
_Notes: Published in the original release as Figure 1; missing from this vintage entirely. Added, using this scenario's own current level (2.418 + Table 2 contribution total)._
