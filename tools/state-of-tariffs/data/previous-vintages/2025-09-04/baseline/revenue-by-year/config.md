...
_Notes: Published in the original release as Table 3 (Table 6 under No-IEEPA), giving Conventional, Dynamic, and the Dynamic effect (relabeled "Difference (Dynamic − Conventional)") by fiscal year, plus 10-year (2026-35) and 11-year (2025-34) totals. Estimates are net of the offsetting reduction in income and payroll tax revenue._
