...
_Notes: Published in the original release as Figure 1; missing from this vintage entirely. Added, using this scenario's own current level (matches the source sheet exactly, since Figure 1 happened to already be computed on a With Greenland Tariffs basis)._
