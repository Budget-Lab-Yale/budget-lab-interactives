...
_Notes: Table only -- the bar-chart part of this figure was removed. Adds a "Difference (Dynamic − Conventional)" row, taken from the source's own "Dynamic effect" row in Table 3, and a "2026-35" 10-year total. No fiscal year 2025 or "2025-34" total, since the source has no FY2025 column for this release._
