...
_Notes: Table only -- the bar-chart part of this figure was removed. Adds a "Difference (Dynamic - Conventional)" row and a "2026-35" 10-year total, both computed directly from the existing conventional/dynamic figures already in this repo (left otherwise untouched, per instruction not to revise core scenario data)._
