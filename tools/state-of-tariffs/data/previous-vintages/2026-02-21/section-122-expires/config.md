...
_Notes: Published in the original release as Figure 1; missing from this vintage entirely. Added. The source's own Figure 1 sheet already computes its "Current" reference lines consistently (no stale-value bug this time) using this scenario's own Table 2 total (9.14% pre-substitution / 7.97% post-substitution)._
