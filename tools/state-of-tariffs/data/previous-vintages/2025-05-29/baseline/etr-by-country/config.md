...
spec:
  ...
  subtitle: "As of May 29, 2025, pre- and post-substitution. Percent."
...
As of May 29, 2025, pre- and post-substitution. Percent.

_Notes: Published in the original release as Table 2/Figure 1, "Average Effective US Tariff Rate, New 2025 Policy Through May 23" (label carried over unchanged from the prior report in the source workbook, though the underlying figures reflect the May 28 court ruling removing IEEPA tariffs). China, Canada, Mexico, and Rest of World each contribute additively to the total average effective tariff rate, so the chart renders as a stacked bar per substitution basis (pre-/post-substitution), with the stack total shown above each bar. The table gives the same figures broken out by row._
